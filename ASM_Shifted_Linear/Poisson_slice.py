...
def solve_LB_Slice(nx=10, length=1.0, height=1e-3, nlayers=20, delta=Constant(1.0), dt=100., tmax=1000., xtest=False, ztest=False, artest=False):
    ...
    Un = Function(W)
    Unp1 = Function(W)
    un_slice, uny, pn = split(Un)
    unp1_slice, unp1y, pnp1 = split(Unp1)
    w_slice, wy, phi = TestFunctions(W)
    ...
    unic_slice, unyic, pnic = Un.subfunctions
    unp1ic_slice, unp1yic, pnp1ic = Unp1.subfunctions
    ...
    u0, u0y, P0 = Un.subfunctions
    file_lb.write(u0, u0y, P0)
